# GitHub Copilot Instructions — Pixely Platform

This file provides configuration for GitHub Copilot to work with the Pixely Platform codebase. It references the shared `.claude/` directory for domain knowledge, rules, and skills.
